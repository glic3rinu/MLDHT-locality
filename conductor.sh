...
sleep 200
sed -i 's#10000000/" #100/"#' experiment.sh
sed -i "s/IDS_PER_NODE=10/IDS_PER_NODE=1/" deploy.sh
python split-nodes.py | bash deploy.sh
sleep $((62*60))
...
sed -i 's#100/" #10000000/"#' experiment.sh
python split-nodes.py | bash deploy.sh 1
sleep $((62*60))
